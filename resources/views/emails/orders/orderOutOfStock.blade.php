...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style='max-width:700px;margin:0 auto'>
        ...
        <br>
        <h3 class='text-uppercase text-primary'>Notify order is not available</h3>
        <br>
                    
        <p>Hello <i>{{ $receiver}}</i>,</p>
        <p>We are sorry because products  @foreach ($products as $prod)
                </span> <b>{!!$prod['product']['product_name']!!} </b> and @endforeach you order <span style='font-weight:600'>Shop  @foreach ($products as $prod)
                </span> <i>{{$prod['product']['supplier']['company_name']}} </i> 
            @endforeach
            <span style='font-weight:600px'>current is not available</span>.</p>
            <p>We will get product in 2 days. </p>
            <p>Hope you sympathetic.</p>
